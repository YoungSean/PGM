...
if __name__ == '__main__':
    ...
    # demo_file(".\\data\\Segmentation_11.uai", "minfill", 10)
    # demo_file(".\\data\\Segmentation_12.uai", "minfill", 10)
    # demo_file(".\\data\\Segmentation_13.uai", "minfill", 10)
    # demo_file(".\\data\\Segmentation_14.uai", "minfill", 10)
    # demo_file(".\\data\\Segmentation_15.uai", "minfill", 10)
    demo_file(".\\data\\Segmentation_16.uai", "minfill", 10)
